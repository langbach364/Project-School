    ...
    $(".featured-products .grid").append(`
      <div class="product-item animate__animated animate__fadeIn" data-aos="fade-up">
        <div class="uk-card uk-card-default uk-card-body">
          ...
          <button class="uk-button uk-button-primary view-details" data-key="${product.product_id}">Chi tiết</button>
        </div>
      </div>
    `);
  });
    ...
    if (key !== "*") {
      categoryList.append(`
        <div class="uk-width-1-4@m animate__animated animate__fadeIn" data-aos="fade-up">
          <div class="uk-card uk-card-default uk-card-body category-card">
            <h3 class="uk-card-title">${value}</h3>
            <p>Khám phá các sản phẩm ${value}</p>
          </div>
        </div>
      `);
    }
